...
export default function EditProduct({ product, categories }: { product: Product, categories: any[] }) {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-surface text-on-surface font-sans">
            <Head title={`Edit ${product.name} - Materials Market`} />
            <SiteNavbar />
            ...
            <main className="max-w-4xl mx-auto px-6 py-12 w-full flex-grow">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xl overflow-hidden">
                    <div className="bg-primary p-8 text-white relative overflow-hidden">
                        ...
                        <h1 className="text-3xl font-bold relative z-10">Edit Product</h1>
                        <p className="text-white/80 mt-2 relative z-10">Update your material listing information.</p>
                    </div>
